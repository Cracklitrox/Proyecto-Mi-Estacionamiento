...
class Casilla(models.Model):
    id_estacionamiento = models.ForeignKey('estacionamiento.Estacionamiento', on_delete=models.CASCADE, db_column='id_estacionamiento', verbose_name='Estacionamientos', null=True)
