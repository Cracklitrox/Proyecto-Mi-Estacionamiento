...
urlpatterns = [
    ...
    path('index/estacionamientos/<int:id>/',views.estacionamientos,name='estacionamientos'),
    path('index/estacionamientos/cambiar_casilla/<int:casilla_id>',cambiar_casilla,name='cambiar_casilla'),
